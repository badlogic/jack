...
#pragma once
#ifndef __C89exception_handlerS__
  #define __C89exception_handlerS__
  #include <stdlib.h>
  #include <stdio.h>
  #include <stddef.h>
//  #include <stdbool.h>
...
#define true 1
  ...
  */
  ...
  /**
    ...
    \ingroup c_excpt
  */
  #define e_catch(x) else if(exception_catch((int)(x))) \
  ...
  /**
    ...
    \ingroup c_excpt
  */
  #define e_rescue else if(exception_rescue()) \
    for((void)0; exception_get(); exception_clear())
  /**
    ...
    \ingroup c_excpt
  */
  #define e_finally else if(exception_finally())
  /**
    ...
    \ingroup c_excpt
  */
  #define e_throw(x) exception_throw((int)(x), __FILE__, __LINE__, __func__)
  /**
    ...
    \ingroup c_excpt
  */
  #define e_retry exception_retry()
  /**
    ...
    \ingroup c_excpt
  */
  #define e_comeback exception_comeback()
  /**
