...
public class AndroidNdkScriptGenerator {
	public void generate (BuildConfig config, BuildTarget target) {
		...
		application.writeString(new FileDescriptor("com/badlogic/jack/build/resources/scripts/Application.mk.template",
			FileType.Classpath).readString(), false);

		// create Android.mk file
		String template = new FileDescriptor("com/badlogic/jack/build/resources/scripts/Android.mk.template", FileType.Classpath)
			.readString();
